...
public class DigitalWarrantyTrackerTestSuiteTest {
    ...
    // ---------------------------
    // 4) Hibernate configurations and CRUD operations
    // ---------------------------
    @Test(priority = 20)
    ...
    // ---------------------------
    // 5) JPA mapping with normalization
    // ---------------------------
    @Test(priority = 24)
    ...
    // ---------------------------
    // 6) Many-to-Many relationships (simulated)
    // ---------------------------
    @Test(priority = 27)
    ...
    // ---------------------------
    // 7) Security controls and JWT authentication
    // ---------------------------
    @Test(priority = 30)
    ...
    // ---------------------------
    // 8) HQL and HCQL advanced data querying
    // ---------------------------
    @Test(priority = 34)
    ...
    public void exceptionhandler_processes_validation_error() {
        com.example.demo.exception.GlobalExceptionHandler handler = 
            new com.example.demo.exception.GlobalExceptionHandler();
